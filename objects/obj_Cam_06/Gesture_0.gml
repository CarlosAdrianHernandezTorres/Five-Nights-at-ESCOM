...
if(global.Cam06 == 0)
{
	...
	/// @DnDHash : 61044FE6
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam_06B"
	/// @DnDSaveInfo : "spriteind" "spr_Cam_06B"
	sprite_index = spr_Cam_06B;
	image_index = 0;
	...
	/// @DnDApplyTo : {obj_Dots}
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Dot_6"
	/// @DnDSaveInfo : "spriteind" "spr_Dot_6"
	with(obj_Dots) {
	sprite_index = spr_Dot_6;
	image_index = 0;
	}
	...
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam06L"
	/// @DnDSaveInfo : "spriteind" "spr_Cam06L"
	with(obj_Lugares) {
	sprite_index = spr_Cam06L;
	image_index = 0;
	}
