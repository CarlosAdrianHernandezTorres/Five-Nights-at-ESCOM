...
if(global.Cam16 == 0)
{
	...
	/// @DnDHash : 60881B9A
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam_16B"
	/// @DnDSaveInfo : "spriteind" "spr_Cam_16B"
	sprite_index = spr_Cam_16B;
	image_index = 0;
	...
	/// @DnDApplyTo : {obj_Dots}
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Dot_16"
	/// @DnDSaveInfo : "spriteind" "spr_Dot_16"
	with(obj_Dots) {
	sprite_index = spr_Dot_16;
	image_index = 0;
	}
	...
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam16L"
	/// @DnDSaveInfo : "spriteind" "spr_Cam16L"
	with(obj_Lugares) {
	sprite_index = spr_Cam16L;
	image_index = 0;
	}
