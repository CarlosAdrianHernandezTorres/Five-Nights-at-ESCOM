...
if(global.Cam18 == 0)
{
	...
	/// @DnDHash : 02CCDD9C
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam_18B"
	/// @DnDSaveInfo : "spriteind" "spr_Cam_18B"
	sprite_index = spr_Cam_18B;
	image_index = 0;
	...
	/// @DnDApplyTo : {obj_Dots}
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Dot_18"
	/// @DnDSaveInfo : "spriteind" "spr_Dot_18"
	with(obj_Dots) {
	sprite_index = spr_Dot_18;
	image_index = 0;
	}
