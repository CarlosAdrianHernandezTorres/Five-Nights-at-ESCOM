...
if(global.Cam15 == 0)
{
	...
	/// @DnDHash : 36D30A5B
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam_15B"
	/// @DnDSaveInfo : "spriteind" "spr_Cam_15B"
	sprite_index = spr_Cam_15B;
	image_index = 0;
	...
	/// @DnDApplyTo : {obj_Dots}
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Dot_15"
	/// @DnDSaveInfo : "spriteind" "spr_Dot_15"
	with(obj_Dots) {
	sprite_index = spr_Dot_15;
	image_index = 0;
	}
	...
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam15L"
	/// @DnDSaveInfo : "spriteind" "spr_Cam15L"
	with(obj_Lugares) {
	sprite_index = spr_Cam15L;
	image_index = 0;
	}
