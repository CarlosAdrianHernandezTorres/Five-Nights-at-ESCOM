...
if(global.Cam01 == 0)
{
	...
	/// @DnDHash : 79F808A6
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam_01B"
	/// @DnDSaveInfo : "spriteind" "spr_Cam_01B"
	sprite_index = spr_Cam_01B;
	image_index = 0;
	...
	/// @DnDApplyTo : {obj_Dots}
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Dot_1"
	/// @DnDSaveInfo : "spriteind" "spr_Dot_1"
	with(obj_Dots) {
	sprite_index = spr_Dot_1;
	image_index = 0;
	}
	...
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam01L"
	/// @DnDSaveInfo : "spriteind" "spr_Cam01L"
	with(obj_Lugares) {
	sprite_index = spr_Cam01L;
	image_index = 0;
	}
