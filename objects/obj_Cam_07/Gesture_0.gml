...
if(global.Cam07 == 0)
{
	...
	/// @DnDHash : 42DDF295
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam_07B"
	/// @DnDSaveInfo : "spriteind" "spr_Cam_07B"
	sprite_index = spr_Cam_07B;
	image_index = 0;
	...
	/// @DnDApplyTo : {obj_Dots}
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Dot_7"
	/// @DnDSaveInfo : "spriteind" "spr_Dot_7"
	with(obj_Dots) {
	sprite_index = spr_Dot_7;
	image_index = 0;
	}
	...
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam07L"
	/// @DnDSaveInfo : "spriteind" "spr_Cam07L"
	with(obj_Lugares) {
	sprite_index = spr_Cam07L;
	image_index = 0;
	}
