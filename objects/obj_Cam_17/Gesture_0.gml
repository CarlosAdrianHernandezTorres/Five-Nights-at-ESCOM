...
if(global.Cam17 == 0)
{
	...
	/// @DnDHash : 4005D00B
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam_17B"
	/// @DnDSaveInfo : "spriteind" "spr_Cam_17B"
	sprite_index = spr_Cam_17B;
	image_index = 0;
	...
	/// @DnDApplyTo : {obj_Dots}
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Dot_17"
	/// @DnDSaveInfo : "spriteind" "spr_Dot_17"
	with(obj_Dots) {
	sprite_index = spr_Dot_17;
	image_index = 0;
	}
	...
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam17L"
	/// @DnDSaveInfo : "spriteind" "spr_Cam17L"
	with(obj_Lugares) {
	sprite_index = spr_Cam17L;
	image_index = 0;
	}
