...
if(global.Cam10 == 0)
{
	...
	/// @DnDHash : 0E6B90A8
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam_10B"
	/// @DnDSaveInfo : "spriteind" "spr_Cam_10B"
	sprite_index = spr_Cam_10B;
	image_index = 0;
	...
	/// @DnDApplyTo : {obj_Dots}
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Dot_10"
	/// @DnDSaveInfo : "spriteind" "spr_Dot_10"
	with(obj_Dots) {
	sprite_index = spr_Dot_10;
	image_index = 0;
	}
	...
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam10L"
	/// @DnDSaveInfo : "spriteind" "spr_Cam10L"
	with(obj_Lugares) {
	sprite_index = spr_Cam10L;
	image_index = 0;
	}
