...
if(global.Cam11 == 0)
{
	...
	/// @DnDHash : 48609E4D
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam_11B"
	/// @DnDSaveInfo : "spriteind" "spr_Cam_11B"
	sprite_index = spr_Cam_11B;
	image_index = 0;
	...
	/// @DnDApplyTo : {obj_Dots}
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Dot_11"
	/// @DnDSaveInfo : "spriteind" "spr_Dot_11"
	with(obj_Dots) {
	sprite_index = spr_Dot_11;
	image_index = 0;
	}
	...
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam11L"
	/// @DnDSaveInfo : "spriteind" "spr_Cam11L"
	with(obj_Lugares) {
	sprite_index = spr_Cam11L;
	image_index = 0;
	}
