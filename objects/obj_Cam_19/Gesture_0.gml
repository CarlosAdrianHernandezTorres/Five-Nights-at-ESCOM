...
if(global.Cam19 == 0)
{
	...
	/// @DnDVersion : 1
	/// @DnDHash : 6C335B15
	/// @DnDApplyTo : {obj_Cam_04}
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam_04A"
	/// @DnDSaveInfo : "spriteind" "spr_Cam_04A"
	with(obj_Cam_04) {
	sprite_index = spr_Cam_04A;
	image_index = 0;
	}
	...
	/// @DnDHash : 0D56BA74
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam_19B"
	/// @DnDSaveInfo : "spriteind" "spr_Cam_19B"
	sprite_index = spr_Cam_19B;
	image_index = 0;
	...
	/// @DnDApplyTo : {obj_Dots}
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Dot_OFF"
	/// @DnDSaveInfo : "spriteind" "spr_Dot_OFF"
	with(obj_Dots) {
	sprite_index = spr_Dot_OFF;
	image_index = 0;
	}
	...
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam18L"
	/// @DnDSaveInfo : "spriteind" "spr_Cam18L"
	with(obj_Lugares) {
	sprite_index = spr_Cam18L;
	image_index = 0;
	}
