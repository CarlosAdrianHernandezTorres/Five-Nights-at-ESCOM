...
if(global.Cam03 == 0)
{
	...
	/// @DnDHash : 15950CFC
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam_03B"
	/// @DnDSaveInfo : "spriteind" "spr_Cam_03B"
	sprite_index = spr_Cam_03B;
	image_index = 0;
	...
	/// @DnDApplyTo : {obj_Dots}
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Dot_3"
	/// @DnDSaveInfo : "spriteind" "spr_Dot_3"
	with(obj_Dots) {
	sprite_index = spr_Dot_3;
	image_index = 0;
	}
	...
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam03L"
	/// @DnDSaveInfo : "spriteind" "spr_Cam03L"
	with(obj_Lugares) {
	sprite_index = spr_Cam03L;
	image_index = 0;
	}
