...
if(global.Cam14 == 0)
{
	...
	/// @DnDHash : 10FFE9D0
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam_14B"
	/// @DnDSaveInfo : "spriteind" "spr_Cam_14B"
	sprite_index = spr_Cam_14B;
	image_index = 0;
	...
	/// @DnDApplyTo : {obj_Dots}
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Dot_14"
	/// @DnDSaveInfo : "spriteind" "spr_Dot_14"
	with(obj_Dots) {
	sprite_index = spr_Dot_14;
	image_index = 0;
	}
	...
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam14L"
	/// @DnDSaveInfo : "spriteind" "spr_Cam14L"
	with(obj_Lugares) {
	sprite_index = spr_Cam14L;
	image_index = 0;
	}
