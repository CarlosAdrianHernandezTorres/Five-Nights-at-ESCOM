...
if(global.Cam12 == 0)
{
	...
	/// @DnDHash : 6DD825AD
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam_12B"
	/// @DnDSaveInfo : "spriteind" "spr_Cam_12B"
	sprite_index = spr_Cam_12B;
	image_index = 0;
	...
	/// @DnDApplyTo : {obj_Dots}
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Dot_12"
	/// @DnDSaveInfo : "spriteind" "spr_Dot_12"
	with(obj_Dots) {
	sprite_index = spr_Dot_12;
	image_index = 0;
	}
	...
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam12L"
	/// @DnDSaveInfo : "spriteind" "spr_Cam12L"
	with(obj_Lugares) {
	sprite_index = spr_Cam12L;
	image_index = 0;
	}
