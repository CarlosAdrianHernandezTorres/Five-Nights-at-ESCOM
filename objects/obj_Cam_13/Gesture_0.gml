...
if(global.Cam13 == 0)
{
	...
	/// @DnDHash : 4DB404ED
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam_13B"
	/// @DnDSaveInfo : "spriteind" "spr_Cam_13B"
	sprite_index = spr_Cam_13B;
	image_index = 0;
	...
	/// @DnDApplyTo : {obj_Dots}
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Dot_13"
	/// @DnDSaveInfo : "spriteind" "spr_Dot_13"
	with(obj_Dots) {
	sprite_index = spr_Dot_13;
	image_index = 0;
	}
	...
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam13L"
	/// @DnDSaveInfo : "spriteind" "spr_Cam13L"
	with(obj_Lugares) {
	sprite_index = spr_Cam13L;
	image_index = 0;
	}
