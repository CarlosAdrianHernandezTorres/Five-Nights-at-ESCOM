...
if(global.Cam09 == 0)
{
	...
	/// @DnDHash : 34AE60FB
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam_09B"
	/// @DnDSaveInfo : "spriteind" "spr_Cam_09B"
	sprite_index = spr_Cam_09B;
	image_index = 0;
	...
	/// @DnDApplyTo : {obj_Dots}
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Dot_9"
	/// @DnDSaveInfo : "spriteind" "spr_Dot_9"
	with(obj_Dots) {
	sprite_index = spr_Dot_9;
	image_index = 0;
	}
	...
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam09L"
	/// @DnDSaveInfo : "spriteind" "spr_Cam09L"
	with(obj_Lugares) {
	sprite_index = spr_Cam09L;
	image_index = 0;
	}
