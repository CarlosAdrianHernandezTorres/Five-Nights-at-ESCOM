...
if(global.Cam02 == 0)
{
	...
	/// @DnDHash : 0B2210F6
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam_02B"
	/// @DnDSaveInfo : "spriteind" "spr_Cam_02B"
	sprite_index = spr_Cam_02B;
	image_index = 0;
	...
	/// @DnDApplyTo : {obj_Dots}
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Dot_2"
	/// @DnDSaveInfo : "spriteind" "spr_Dot_2"
	with(obj_Dots) {
	sprite_index = spr_Dot_2;
	image_index = 0;
	}
	...
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam02L"
	/// @DnDSaveInfo : "spriteind" "spr_Cam02L"
	with(obj_Lugares) {
	sprite_index = spr_Cam02L;
	image_index = 0;
	}
