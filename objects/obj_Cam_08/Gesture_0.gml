...
if(global.Cam08 == 0)
{
	...
	/// @DnDHash : 6F205897
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam_08B"
	/// @DnDSaveInfo : "spriteind" "spr_Cam_08B"
	sprite_index = spr_Cam_08B;
	image_index = 0;
	...
	/// @DnDApplyTo : {obj_Dots}
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Dot_8"
	/// @DnDSaveInfo : "spriteind" "spr_Dot_8"
	with(obj_Dots) {
	sprite_index = spr_Dot_8;
	image_index = 0;
	}
	...
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam08L"
	/// @DnDSaveInfo : "spriteind" "spr_Cam08L"
	with(obj_Lugares) {
	sprite_index = spr_Cam08L;
	image_index = 0;
	}
