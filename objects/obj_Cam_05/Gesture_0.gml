...
if(global.Cam05 == 0)
{
	...
	/// @DnDHash : 070C9800
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam_05B"
	/// @DnDSaveInfo : "spriteind" "spr_Cam_05B"
	sprite_index = spr_Cam_05B;
	image_index = 0;
	...
	/// @DnDApplyTo : {obj_Dots}
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Dot_5"
	/// @DnDSaveInfo : "spriteind" "spr_Dot_5"
	with(obj_Dots) {
	sprite_index = spr_Dot_5;
	image_index = 0;
	}
	...
	/// @DnDParent : 0B580D2A
	/// @DnDArgument : "spriteind" "spr_Cam05L"
	/// @DnDSaveInfo : "spriteind" "spr_Cam05L"
	with(obj_Lugares) {
	sprite_index = spr_Cam05L;
	image_index = 0;
	}
